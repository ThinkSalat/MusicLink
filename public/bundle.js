...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(29);
...
const retrieveArtistBio = artistId => {
  ...
  callSpotifyAPI(url)
    .then( res => {
      ...
      console.log(__WEBPACK_IMPORTED_MODULE_1_jquery__["jQuery"]);
      const fullPage = __WEBPACK_IMPORTED_MODULE_1_jquery__["$"].parseHTML(res.data)
